...
export default function About() {
  return (
    <div className="min-h-screen bg-ab-bg text-ab-text font-inter">
      ...
      {/* ── HERO ────────────────────────────────────────────── */}
      <section className="bg-ab-primary py-24 md:py-32 text-center">
      ...
      {/* ── FRAGMENTATION ───────────────────────────────────── */}
      <section className="py-20 md:py-28 bg-ab-bg">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16 lg:px-24 grid lg:grid-cols-2 gap-16 items-center">
      ...
      {/* ── UNIFIED ECOSYSTEM ───────────────────────────────── */}
      <section className="py-20 md:py-28 text-center bg-ab-bg">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16 lg:px-24">
          <h2
      ...
      {/* ── "JUST A GAME" ────────────────────────────────────── */}
      <section className="py-20 md:py-28 bg-ab-bg-section">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16 lg:px-24 grid lg:grid-cols-2 gap-16 items-start">
          <div className="h-72 md:h-[380px] bg-black/70 rounded-2xl shadow-xl flex items-center justify-center text-ab-text-muted text-sm">
            Feature Video
          </div>
      ...
      {/* ── OUR PHILOSOPHY ──────────────────────────────────── */}
      <section className="py-20 md:py-28 text-center bg-ab-bg-section">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16 lg:px-24">
          <h2
