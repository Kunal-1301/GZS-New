...
export default function Profile() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-pr-bg font-inter w-full overflow-x-hidden">
            ...
            <main className="flex-1 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-8 md:py-12 -mt-20 md:-mt-28 relative z-10 flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12">
