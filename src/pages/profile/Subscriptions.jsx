            ...
            <section>
                ...
                <div className="bg-pr-surface border border-pr-text shadow-sm rounded-xl p-6 lg:p-8 flex flex-col md:flex-row gap-8 justify-between items-start md:items-center relative overflow-hidden">
                    ...
                    <div className="flex flex-col gap-3 w-full md:w-auto mt-4 md:mt-0">
                        <button className="w-full px-8 py-3.5 bg-pr-primary hover:bg-pr-primary-dark text-white text-xs font-black uppercase tracking-widest rounded-lg transition-colors shadow-md hover:-translate-y-0.5 whitespace-nowrap">
                            Upgrade to Annual
                        </button>
                        <button
                            onClick={() => setShowCancelModal(true)}
                            className="w-full px-8 py-3 bg-white border border-red-200 text-red-500 hover:bg-red-50 hover:border-red-300 text-[10px] font-black uppercase tracking-widest rounded-lg transition-colors shadow-sm whitespace-nowrap"
                        >
                            Cancel Subscription
                        </button>
                    </div>
