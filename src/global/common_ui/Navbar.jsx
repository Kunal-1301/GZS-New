...
function Navbar() {
  ...
  const profileLinks = [
    { label: 'Master Identity Hub', path: '/profile/master', icon: FiGrid },
    { label: 'Social Profile', path: '/profile', icon: FiUser },
    ...
    { label: 'Facade Setup', path: '/profile-setup', icon: FiInfo },
    { label: 'Switch Facade', path: '/profile/choose-subprofile', icon: FiGrid },
  ];
              ...
              <div className="absolute right-0 top-12 z-50 w-56 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden">
                ...
                <div className="border-t border-gray-100">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-2.5 text-xs font-semibold text-gray-500 hover:bg-red-50 hover:text-red-600 transition-colors"
                  >
