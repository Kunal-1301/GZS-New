...
// This requires 'glob' which might not be installed, let's just use basic recursive fs
...
walkDir('./src', function(filePath) {
  if (filePath.endsWith('.jsx')) {
    ...
    content = content.replace(/max-w-\[1440px\]\s+mx-auto\s+px-6\s+md:px-16\s+lg:px-24/g, 'container-global');
    content = content.replace(/max-w-\[1440px\]\s+mx-auto/g, 'container-global');
